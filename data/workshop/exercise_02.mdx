...
Here is some useful documentation, first to make sure you understand the subtle difference between
...
However, if you are fast enough, you may catch the link on time, right when a new pod starts (replacing a deleted one)
