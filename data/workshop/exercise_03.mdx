...
You will not be able to do the following, because starting a terminal from your 2048 pod will fail, due to very tight memory constraint
in this case. But for you, I took a screenshot comparing the memory as seen by the 2048 pod, and the node. The values are equal.
